...
{	
	...
	public RespMsg ( Object respData )
	{
		...
		if ( respData instanceof ReqMsg ) {
			((ReqMsg)respData).setRelClass(null);
		}
	}
	...
	{
		if ( respData!=null && respData instanceof ReqMsg ) {
			ReqMsg rm = (ReqMsg)respData;
			rm.setLoginToken(null);
		}
	}
